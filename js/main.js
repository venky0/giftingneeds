...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try { initFaqs(); } catch (e) { console.warn('initFaqs error:', e); }
  try { initSlideshow(); } catch (e) { console.warn('initSlideshow error:', e); }
  try { initClientTicker(); } catch (e) { console.warn('initClientTicker error:', e); }
  try { initProductCatalog(); } catch (e) { console.warn('initProductCatalog error:', e); }
  try { initKitBuilder(); } catch (e) { console.warn('initKitBuilder error:', e); }
  try { initInquiryModal(); } catch (e) { console.warn('initInquiryModal error:', e); }
  try { initInquiryForm(); } catch (e) { console.warn('initInquiryForm error:', e); }
  try { initDealerCalculator(); } catch (e) { console.warn('initDealerCalculator error:', e); }
